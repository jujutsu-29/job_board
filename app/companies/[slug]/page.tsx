      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <section className="mb-12" aria-labelledby="about-heading">
          <Card className="shadow-sm border bg-card">
            <CardHeader>
              <CardTitle id="about-heading" className="text-2xl font-bold text-foreground">
                About the Company
              </CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <Card className="shadow-sm border bg-card">
              <CardContent className="text-center py-12">
                ...
                <p className="text-muted-foreground">
                  We don't have any open positions at the moment, but we're always looking for great talent. Check back
                  soon!
                </p>
              </CardContent>
            </Card>
